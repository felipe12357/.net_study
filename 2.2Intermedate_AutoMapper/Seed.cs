...
public class Seed
    {
        public void Run()
        {
            ...
            string tableCreateSql = System.IO.File.ReadAllText("Files/Users.sql");
            dataContextDapper.ExecuteSQL(tableCreateSql);

            string usersJson = System.IO.File.ReadAllText("Files/Users.json");
            ...
            string userSalaryJson = System.IO.File.ReadAllText("Files/UserSalary.json");
            ...
            string userJobInfoJson = System.IO.File.ReadAllText("Files/UserJobInfo.json");
